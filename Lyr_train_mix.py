...
class MIX(nn.Module):
    ...
    def __init__(self,model_cnn,model_lyrics):
        ...
        model_lyr.load_state_dict(torch.load('./model/BERT_l_6_Lyc_pq/best_net.pt'))
        self.lyrics = model_lyr.encoder
        self.audio  = eval(model_cnn+'(**parms)')
        self.audio.load_state_dict(torch.load('./model/Cnn6_l_6_Lyr_pq/best_net.pt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model1",help='Cnn6')
    parser.add_argument("--model2",help='BERT')
    ...
    save_path = 'MIX_{}_{}_{}_{}_Lyr_{}'.format(args.model1,args.model2,args.size,str(args.bt),args.data)
